                    ...
                    <div className='nameAreaTop'>
                        ...
                        <div className='name'>
                            ...
                            <div className='rightSpace'>
                                <div className='rightSpace_child'><TooltipJSX setID={data.nameID + 'r_left'} text={data.r_left} icon='' html={data.r_left_tooltip} class={data.r_left_color}/></div>
                                <div className='rightSpace_child'><TooltipJSX setID={data.nameID + 'r_center'} text={data.r_center} icon='' html={data.r_center_tooltip} class={data.r_center_color}/></div>
                                <div className='rightSpace_child'><TooltipJSX setID={data.nameID + 'r_right'} text={data.r_right} icon='' html={data.r_right_tooltip} class={data.r_right_color}/></div>
                            </div>
                        </div>
                    </div>
                </div>
