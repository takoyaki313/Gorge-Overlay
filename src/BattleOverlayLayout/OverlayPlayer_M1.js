...
export const OverlayM1 = (prop) => {
    ...
    return (
        <div className='mainRow m1_overlay' >
                    ...
                    <div className='nameAreaTop'>
                        ...
                        <div className='name'>
                            ...
                            <div className='rightSpace'>
                                <div className='rightSpace_child'><TooltipJSX setID={data.nameID + 'r_left'} text={data.r_left} icon='' html={data.r_left_tooltip} /></div>
                                <div className='rightSpace_child'><TooltipJSX setID={data.nameID + 'r_center'} text={data.r_center} icon='' html={data.r_center_tooltip} /></div>
                                <div className='rightSpace_child'><TooltipJSX setID={data.nameID + 'r_right'} text={data.r_center} icon='' html={data.r_right_tooltip} /></div>
                            </div>
                        </div>
                    </div>
                </div>
