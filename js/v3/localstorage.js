...
const Localstorage_dictionary = {
  ...
  rw_perosn_raibow: {
    ...
    min_value: 1,
    max_value: 100000,
    title_ja: '一定DPS以上をレインボーにする。（RW）※無効化中',
    title_en: 'Make a certain DPS or higher a rainbow (RW) ※disabled',
  ...
  lb_int_fontsize: {
    ...
    min_value: 1,
    max_value: 99,
    title_ja: 'IntLBのフォントサイズ',
    title_en: 'IntLB font size',
    description_ja: '別オーバレイ「IntLB」のフォントサイズを変更する。リロード必要',
  ...
  VERSION: {
    func_name: null,
    value: 'Gorge-overlay3.1 Rev.7.1',
    title_ja: 'Version : ',
    title_en: 'Version : ',
    description_ja: '',
    description_en: '',
