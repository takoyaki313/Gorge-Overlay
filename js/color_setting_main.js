...
$(document).on("click","input[name='sample-data-type']",function(){
  ...
  dammy();
  if(select_type === 'RW'){
    $("#source").load("https://takoyaki313.github.io/Gorge-Overlay/Gorge-Overlay2.html #gorge-source", function(gorge_source) {
    ...
    $("#source").load("https://takoyaki313.github.io/Gorge-Overlay/Gorge-Overlay2.html #fl-source", function(fl_source) {
    if(fl_source == null){
    $("#source").append("読込みに失敗しました");
    console.log('Failed...');
    }
